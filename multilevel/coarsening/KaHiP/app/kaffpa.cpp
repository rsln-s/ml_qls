...
int main(int argn, char **argv) {
       ...
       // std::cout<< "\t \t matching type set to: " << partition_config.matching_type << std::endl;
        if(ret_code) {
                return 0;
        }
        ...
        std::string working_dir = std::getenv("ML_QUANTUM_WORKING_DIR");
        graph_io::writeGraphWeighted(G, working_dir + "multilevel_quantum/coarsening/coarsened_graphs/graphs/graph0.txt");
